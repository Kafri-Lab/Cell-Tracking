...
% Results table (Camilla)
data_path = '\\carbon.research.sickkids.ca\rkafri\DanielS\Images\20180112_CG_DPC_ROS__2018-01-12T17_35_12-Measurement1_Field41\ResultTable.mat';
...
% Images path
% folder = 'Z:\OPRETTA\Operetta Raw Data\Mammalian cells\20171103_RB_LFS__2017-11-03T17_30_39-Measurement1\Images\'; % (Ron)
folder = '\\carbon.research.sickkids.ca\rkafri\DanielS\Images\20180112_CG_DPC_ROS__2018-01-12T17_35_12-Measurement1_Field41\'; % (Camilla)
...
% coloured_imgs = overlay_nuc_and_nuc(SubsetTable, nuc);
coloured_imgs = overlay_cyto_on_cyto(SubsetTable, cyto);
